    ...
    return (
        <div ref={layoutRef} className="w-full h-[400px] flex flex-row gap-2 relative">
            <div className="flex-1">
                <FakeBlock icon="terminal" name={t("onboardingFeatures.terminalBlockName")} />
            </div>
            <div className="flex-1 flex flex-col gap-2">
                <div className="flex-1">
                    <FakeBlock icon="globe" name={t("onboardingFeatures.webBlockName")} />
                </div>
                <div className="flex-1" ref={highlightedContainerRef}>
                    <FakeBlock
                        icon="terminal"
                        name={t("onboardingFeatures.terminalBlockName")}
                        highlighted={true}
                        className="opacity-0"
                    />
                </div>
            ...
            {blockRect && (
                <>
                    ...
                    <div className="absolute transition-all duration-200 ease-in-out" style={getAnimatedStyle()}>
                        <FakeBlock icon="terminal" name={t("onboardingFeatures.terminalBlockName")} highlighted={true} />
                    </div>
                </>
            )}
        </div>
