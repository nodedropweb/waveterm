                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-8 pr-6 unselectable">
                    <div className="flex flex-col items-start gap-6 max-w-md">
                        ...
                        <div className="flex flex-col items-start gap-4 text-secondary">
                            <p>{t("onboardingFeatures.waveAIIntro")}</p>

                            <div className="flex items-start gap-3 w-full">
                                <i className="fa fa-sparkles text-accent text-lg mt-1 flex-shrink-0" />
                                <p>
                                    {t("onboardingFeatures.toggleWithButtonPrefix")}{" "}
                                    ...
                                    {t("onboardingFeatures.toggleWithButtonSuffix")}
                                </p>
                            </div>
                            ...
                            <div className="flex items-start gap-3 w-full">
                                ...
                                <p>
                                    {t("onboardingFeatures.toggleWithShortcutPrefix")}{" "}
                                    <span className="font-mono font-semibold text-foreground whitespace-nowrap">
                                        {shortcutKey}
                                    </span>{" "}
                                    {t("onboardingFeatures.toggleWithShortcutSuffix")}
                                </p>
                            </div>

                            <div className="flex items-start gap-3 w-full">
                                <i className="fa fa-key text-accent text-lg mt-1 flex-shrink-0" />
                                <p>{t("onboardingFeatures.byokInfo")}</p>
                            </div>
    ...
    return (
        <div className="flex flex-col h-full">
            <header className="flex items-center gap-4 mb-6 w-full unselectable flex-shrink-0">
                ...
                <div className="text-[25px] font-normal text-foreground">{t("onboardingFeatures.magnifyTitle")}</div>
            </header>
            <div className="flex-1 flex flex-row gap-0 min-h-0">
                <div className="flex-1 flex flex-col items-center justify-center gap-8 pr-6 unselectable">
                    ...
                    <div className="flex flex-col items-start gap-4 text-secondary max-w-md">
                        <p>{t("onboardingFeatures.magnifyIntro")}</p>
                        <p>{t("onboardingFeatures.magnifyUsage")}</p>
                        <div>
                            {t("onboardingFeatures.magnifyIconPrefix")}{" "}
                            <span className="inline-block align-middle [&_svg_path]:!fill-foreground">
                                <MagnifyIcon enabled={false} />
                            </span>{" "}
                            {t("onboardingFeatures.magnifyIconSuffix")}
                        </div>
                        <p>{t("onboardingFeatures.magnifyShortcutHint", { key: shortcutKey })}</p>
                        <EmojiButton emoji="🔥" isClicked={fireClicked} onClick={handleFireClick} />
                    </div>
                </div>
                <div className="w-[2px] bg-border flex-shrink-0"></div>
    ...
    return (
        <div className="flex flex-col h-full">
            <header className="flex items-center gap-4 mb-6 w-full unselectable flex-shrink-0">
                ...
                <div className="text-[25px] font-normal text-foreground">{t("onboardingFeatures.filesTitle")}</div>
            </header>
            <div className="flex-1 flex flex-row gap-0 min-h-0">
                <div className="flex-1 flex flex-col items-center justify-center gap-8 pr-6 unselectable">
                    <div className="flex flex-col items-start gap-6 max-w-md">
                        <div className="flex flex-col items-start gap-4 text-secondary">
                            <p>{t("onboardingFeatures.filesIntro")}</p>

                            <div className="flex items-start gap-3 w-full">
                                <i className="fa fa-eye text-accent text-lg mt-1 flex-shrink-0" />
                                <div>
                                    <p className="mb-2">
                                        {t("onboardingFeatures.filesViewPrefix")}{" "}
                                        <span className="font-mono font-semibold text-foreground">
                                            wsh view [filename]
                                        </span>{" "}
                                        {t("onboardingFeatures.filesViewSuffix")}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3 w-full">
                                ...
                                <div>
                                    <p className="mb-2">
                                        {t("onboardingFeatures.filesEditPrefix")}{" "}
                                        <span className="font-mono font-semibold text-foreground">
                                            wsh edit [filename]
                                        </span>{" "}
                                        {t("onboardingFeatures.filesEditSuffix")}
                                    </p>
                                </div>
                            </div>

                            <p>{t("onboardingFeatures.filesOutro")}</p>
