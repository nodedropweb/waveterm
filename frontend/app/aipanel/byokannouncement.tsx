        ...
        <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4 mt-4">
            <div className="flex items-start gap-3">
                ...
                <div className="text-left flex-1">
                    <div className="text-blue-400 font-medium mb-1">{t("aiPanel.byokTitle")}</div>
                    <div className="text-secondary text-sm mb-3">{t("aiPanel.byokDescription")}</div>
                    <div className="flex items-center gap-3">
                        ...
                        >
                            {t("aiPanel.viewDocs")} <i className="fa fa-external-link text-xs"></i>
                        </a>
                    </div>
                </div>
            </div>
