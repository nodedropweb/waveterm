            ...
            <div className="flex items-center justify-center p-8 text-center">
                <div className="max-w-md space-y-6">
                    <div className="space-y-4">
                        ...
                        <p className="text-secondary leading-relaxed">{t("aiPanel.telemetryIntro")}</p>
                    </div>
                    ...
                    <div className="bg-blue-900/20 border border-blue-500 rounded-lg p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-left">
                                <div className="text-blue-400 font-medium mb-1">{t("aiPanel.telemetryKeepsFree")}</div>
                                <div className="text-secondary text-sm mb-3">
                                    <p className="mb-2">{t("aiPanel.telemetryParagraph1")}</p>
                                    <p className="mb-2">{t("aiPanel.telemetryParagraph2")}</p>
                                    <p className="mb-2">{t("aiPanel.telemetryParagraph3")}</p>
                                    <p>
                                        {t("aiPanel.telemetryByokInfo")}{" "}
                                        <a
                                ...
                                >
                                    {isEnabling ? t("aiPanel.enabling") : t("aiPanel.enableTelemetryAndContinue")}
                                </button>
                            </div>
                        </div>
                    </div>
