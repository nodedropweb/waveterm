    ...
    return (
        <div className="flex flex-col p-1">
            ...
            <div className="flex items-center gap-1 mt-0.5 text-error">
                ...
                <span>{t("widgets.configErrors")}</span>
            </div>
        </div>
    );
}
            ...
            >
                <div className="p-4">
                    {loading ? (
                        ...
                        <div className="text-muted text-sm p-4 text-center">{t("widgets.noLocalAppsFound")}</div>
                    ) : (
                        <div
...
const Widgets = memo(() => {
    ...
    const handleWidgetsBarContextMenu = (e: React.MouseEvent) => {
        ...
        const menu: ContextMenuItem[] = [
            {
                label: t("widgets.editWidgetsJson"),
                click: () => {
                    fireAndForget(async () => {
                        const blockDef: BlockDef = {
                            meta: {
        ...
        <>
            ...
            >
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-2 gap-0 w-full">
                            {env.isDev() || featureWaveAppBuilder ? (
                                ...
                                >
                                    <Tooltip content={t("widgets.localWaveApps")} placement="left" disable={isAppsOpen}>
                                        <div>
                ...
                {env.isDev() ? (
                    <div
                        ...
                        title={t("widgets.runningDevBuild")}
                    >
            ...
            >
                ...
                <div className="flex flex-col justify-center items-center w-full py-1.5 pr-0.5 text-lg">
                    ...
                    <div className="text-xxs mt-0.5 w-full px-0.5 text-center">{t("widgets.settingsLabel")}</div>
                </div>
                {env.isDev() ? (
                    <div className="flex flex-col justify-center items-center w-full py-1.5 pr-0.5 text-lg">
                        <div>
                        ...
                        <div className="text-xxs mt-0.5 w-full px-0.5 text-center">{t("widgets.appsLabel")}</div>
                    </div>
                ) : null}
                {env.isDev() ? (
                    <div
