...
| app:language <VersionBadge version="v0.14.5" />                      | string   | Sets the UI language: `"en"` (default) or `"de"`                                                                                                                                                                                                              |
...
| term:scrollback                      | int      | size of terminal scrollback buffer in lines (default 2000, max 500000); higher values use more memory                                                                                                                                                        |
...
```json
{
    ...
    "web:defaulturl": "https://www.google.com",
