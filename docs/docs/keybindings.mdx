...
| <KbdChord karr={["Ctrl:Shift:z", "="]}/>          | Zoom in on the focused block only (increase its content size), leaving other blocks unchanged                                                        |
| <KbdChord karr={["Ctrl:Shift:z", "-"]}/>          | Zoom out on the focused block only (decrease its content size)                                                                                        |
| <KbdChord karr={["Ctrl:Shift:z", "0"]}/>          | Reset the focused block's zoom back to its default size                                                                                               |
